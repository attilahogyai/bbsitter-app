...
export default BaseController.extend({
  ...
  validate:function(){
    ...
    if(firstError){
      //alert('Nem töltöttél ki minden mezőt. Keresd a pirossal keretezetteket.');
      this.send('infoAlert',{text: 'Nem töltöttél ki minden mezőt. Keresd a pirossal keretezetteket.'},function(alertWindow){
