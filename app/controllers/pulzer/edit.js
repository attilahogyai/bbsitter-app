...
export default Ember.ObjectController.extend({
  ...
  eventDate: null,
  startDate: function(key,value,oldValue){
  ...
  }.property('awaitingForAccept','awaitingForClose','showSaveButton','showResignButton'),
  awaitingForAccept:function(){
